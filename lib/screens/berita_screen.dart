import 'package:uasmp/providers/berita_provider.dart';
import 'package:uasmp/screens/beritadetail_screen.dart';
...
class _ArtikelScreenState extends State<ArtikelScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('191011401216 - Aldo Bagus Setiawan',
              style:
